...
export default function ModoPalcoClient({ topics }: { topics: Topic[] }) {
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 md:py-10">
                ...
                {filtered.length === 0 && (
                    <div className="mt-8 rounded-2xl border border-border bg-panel/35 p-6 text-muted">
                        Nada encontrado. Tente outro termo ou pressione{" "}
                        <span className="text-text/90">Esc</span> para limpar.
                    </div>
                )}

                <footer className="mt-10 border-t border-border pt-6 text-xs text-muted/70">
                    Dica: no debate, deixe essa tela aberta e use{" "}
                    <span className="text-text/90">/</span> + digitação rápida.
                </footer>
            </div>
        </main>
    );
